...
import ArticleImg1 from '/article1 img.jpg'
import ArticleImg2 from '/article2img.jpg'
import ArticleImg3 from '/article3img.jpg'
        ...
        <div className='homeContainer'>
            ...
            <section id='project' className='center'>
                ...
                <section className='cardSection center'>
                    <ArticleCard title="Nossa Missão" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ipsum turpis, condimentum ut erat quis, eleifend consectetur eros. Nullam nunc sapien, pellentesque maximus feugiat vitae, vehicula id nisi" articleImg={ArticleImg1} altText="imagem projeto"/>
                    <ArticleCard title="Origem" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ipsum turpis, condimentum ut erat quis, eleifend consectetur eros. Nullam nunc sapien, pellentesque maximus feugiat vitae, vehicula id nisi" articleImg={ArticleImg2} altText="imagem projeto"/>
                    <ArticleCard title="Equipe" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ipsum turpis, condimentum ut erat quis, eleifend consectetur eros. Nullam nunc sapien, pellentesque maximus feugiat vitae, vehicula id nisi" articleImg={ArticleImg3} altText="imagem projeto"/>
                </section>
            </section>
            <section id='posts'>
